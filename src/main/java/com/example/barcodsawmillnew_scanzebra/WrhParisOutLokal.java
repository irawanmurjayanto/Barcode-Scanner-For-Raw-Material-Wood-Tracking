...
public class WrhParisOutLokal extends AppCompatActivity {
    ...
    private Context context = WrhParisOutLokal.this;
...
hideDialog();
    ...
    private void DialogErrorNetwork() {
        dialog = new AlertDialog.Builder(WrhParisOutLokal.this);
