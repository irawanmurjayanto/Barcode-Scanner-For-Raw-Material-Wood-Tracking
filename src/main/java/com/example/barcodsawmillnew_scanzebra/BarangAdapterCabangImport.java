...
public class BarangAdapterCabangImport extends RecyclerView.Adapter<BarangAdapterCabangImport.BarangViewHolder> {



    List<BarangCabang> barangs;
    public BarangAdapterCabangImport(List<BarangCabang> barangs) {
    ...
    public BarangViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_barang_adapter_cabangimport, viewGroup,false);
