...
public class SawmillSub_Checkin extends AppCompatActivity  {
    ...
    private Context context = SawmillSub_Checkin.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sawmill_checkin);
        ...
        butmanualbarc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((textTempSupplier.getText().toString().equals("Group"))||(textTempTipetrans.getText().toString().equals("Tipe"))) {
                    ...
                    a.putExtra("warning", "Lokasi Sawmill atau Tipe Transaksi harus dipilih ");
                    startActivity(a);
            ...
            public void onClick(View view) {
                ...
                if (textTempSupplier.getText().toString().equals("Group") || (textTempTipetrans.getText().toString().equals("Tipe"))) {
                   ...
                   // SawmillSub_Checkin.typebarcode="mastercheckin";
                    SawmillSub_LOG.typebarcode="mastercheckin";
                    //ambilremarks = editremarks.getText().toString();
                    //Toast.makeText(getBaseContext(), "Load barcode", Toast.LENGTH_LONG).show();
                    IntentIntegrator integrator = new IntentIntegrator(SawmillSub_Checkin.this);
                    integrator.setDesiredBarcodeFormats(IntentIntegrator.ALL_CODE_TYPES);
                    integrator.setCaptureActivity(AnyOrientationCaptureActivity.class);
...
//        textTempTipetrans2.setText("IN");
        loadDataLokal();
        gambarDatakeRecyclerView();
getSupplier();//Get Lokasi
getTipetrans();
getLocation2();
spnTipetrans.setEnabled(true);
    }
  ...
  //  params
    ...
    private void setData(String noref) {
        ...
        SQLiteDatabase db = adb_master.getReadableDatabase();
        String sql = "select supplier,typetran from "+ADB_Master.MyColumns_newbarcode_checkin.NamaTabel+" where noref= '" + noref + "'";
        Cursor c = db.rawQuery(sql, null);
        int jum = c.getCount();
        hitbarc = jum;
...
*/
    ...
    private void insertdata() {
        ...
        String selectQuery2 = "SELECT  *  FROM " + ADB_Master.MyColumns_newbarcode_checkin.NamaTabel + " WHERE "
                + ADB_Master.MyColumns_newbarcode_checkin.noref + " = '" + textnoreff.getText().toString() + "' and " + ADB_Master.MyColumns_newbarcode_checkin.barcode + " = '" + item1 + "'";
        ...
        //    final String namacari = cari1.getText().toString();
            ...
            values2.put(ADB_Master.MyColumns_newbarcode_checkin.barcode,item1 );
            values2.put(ADB_Master.MyColumns_newbarcode_checkin.noref,textnoreff.getText().toString() );
            values2.put(ADB_Master.MyColumns_newbarcode_checkin.typetran,textTempTipetrans.getText().toString() );
            values2.put(ADB_Master.MyColumns_newbarcode_checkin.supplier,textTempSupplier.getText().toString() );
            values2.put(ADB_Master.MyColumns_newbarcode_checkin.tagtran,2 );//2 masuk 1 update
            create.insert(ADB_Master.MyColumns_newbarcode_checkin.NamaTabel, null, values2);
...
//            if (event.getKeyCode()==285)
    ...
    //    String namaoven = textTampung3.getText().toString();
        ...
        SQLiteDatabase db = adb_master.getReadableDatabase();
        String sql = "select * from "+ADB_Master.MyColumns_newbarcode_checkin.NamaTabel+" where noref= '" + noref + "'";
        Cursor c = db.rawQuery(sql, null);
        int jum = c.getCount();
        hitbarc = jum;
        jumjumbar = String.valueOf(hitbarc);
        ...
        //  barangListPOS = adb_user.getSemuaUser();
         barangList = adb_master.getSemuaCheckinSub(noref);
...
*/
    ...
    private void DialogErrorNetwork() {
        dialog = new AlertDialog.Builder(SawmillSub_Checkin.this);
        inflater = getLayoutInflater();
...
*/
    ...
    */
    ...
    private void updateTextView(final String s) {
        SawmillSub_Checkin.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                EditText tv= (EditText) findViewById(R.id.editremarks);
                tv.setText("Text = "+s);
...
private void deldatatrans()
{
    ...
    {
        SQLiteDatabase db=adb_master.getWritableDatabase();
        String del1="delete from " +ADB_Master.MyColumns_newbarcode_checkin.NamaTabel+" where noref='"+norefx+"'";
        db.execSQL(del1);
    }
    ...
    {
        SQLiteDatabase db=adb_master.getWritableDatabase();
        String del1="delete from "+ADB_Master.MyColumns_newbarcode_checkin.NamaTabel +" where idno="+idno;
        db.execSQL(del1);
        String upd1="update "+ADB_Master.MyColumns_newbarcode_checkin.NamaTabel +" set tagtran='2' where noref='"+textnoreff.getText().toString()+"'";
        db.execSQL(upd1);
    }
    ...
    private void insertto_test(final String norefx) {
        ...
        SQLiteDatabase db = adb_master.getWritableDatabase();
        String sql1 = "select barcode,tgl_rec,noref,lokasi from "+ADB_Master.MyColumns_newbarcode_checkin.NamaTabel +" where noref='" + textnoreff.getText().toString()+ "' ";
        Cursor cursor = db.rawQuery(sql1, null);
...
//        cursor2.moveToFirst();
//
//        String sql13 = "select max(tgl_rec) from "+ADB_Master.MyColumns_newbarcode_checkin.NamaTabel +" where noref='" + textnoreff.getText().toString()+ "' ";
...
*/
    ...
    */
    ...
    /*    final String macadd1 = textgetmax.getText().toString();
        ...
        String url = AppConfig.IP_SERVER+"sawmill/lokal_insertdatasawmill_checkin_ori.php";
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (errormsg.equals("fail"))
                    {
                        ...
                        Intent a = new Intent(getBaseContext(), warningumum.class);
                        a.putExtra("warning", "Upload Sawmill Checkin Completed");
                        startActivity(a);
                        hideDialog();
                    ...
                    Log.d("BarangActivityxxxxx", "errorJSON");
...
//    }
    ...
    {
        SQLiteDatabase db=adb_master.getWritableDatabase();
        String upd1="update "+ADB_Master.MyColumns_newbarcode_checkin.NamaTabel+" set tagtran=1 where noref='"+norefx+"'";
        db.execSQL(upd1);
    }
