...
public class BarangSawmillLOGMain implements Serializable{
    ...
    public BarangSawmillLOGMain(int id, String supplier, String noref, String tgl_rec, String tipetrans, int tagtran, String skau) {
        this.id = id;
