...
public class Emp_RegAssSaw extends Activity {
    ...
    private Context context = com.example.barcodsawmillnew_scanzebra.Emp_RegAssSaw.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emp__reg_ass);
...
finish();
    ...
    public void loaddatanik(){
       ...
       // Toast.makeText(this,"Load Data "+kode,Toast.LENGTH_LONG).show();
        String url = AppConfig.IP_SERVER+"sawmill/listsection.php";
    ...
    private void processResponsePOS(String response){
        ...
        try {
            ...
            for(int i = 0; i < jsonArray.length(); i++){
                ...
                objectbarang.setSection1(obj.getString("section"));
