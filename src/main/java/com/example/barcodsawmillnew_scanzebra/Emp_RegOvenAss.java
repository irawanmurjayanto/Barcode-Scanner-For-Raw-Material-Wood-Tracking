...
public class Emp_RegOvenAss extends Activity {
    ...
    private Context context = Emp_RegOvenAss.this;
...
finish();
    ...
    public void loaddatanik(){
       ...
       Toast.makeText(this,"Load Data "+getidovn,Toast.LENGTH_LONG).show();
        String url = AppConfig.IP_SERVER+"sawmill/barcsw_ovenloc3.php";
    ...
    private void processResponsePOS(String response){
        ...
        try {
            ...
            for(int i = 0; i < jsonArray.length(); i++){
                ...
                objectbarang.setSection1(obj.getString("ovennames"));
