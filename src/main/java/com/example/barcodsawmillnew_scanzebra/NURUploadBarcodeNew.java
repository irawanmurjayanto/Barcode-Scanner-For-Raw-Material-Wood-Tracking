...
public class NURUploadBarcodeNew extends AppCompatActivity {
    ...
    private Context context = NURUploadBarcodeNew.this;
    ...
    Button butsavegc,butclosegc,butdelgc;

    EditText qty,remarks;
    TextView item_code,item_desc,textIDNO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inventory__barangnew);
    ...
    public void onClick(View v) {
      ...
      //  a.putExtra("wrhtype",wrhtype_get);
       ...
       // Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
       //toolbar.setTitle("Edit Transaksi Import");
    ...
    /*    cari1.setOnKeyListener(new View.OnKeyListener() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Toast.makeText(getBaseContext(), "Load barcode", Toast.LENGTH_LONG).show();
                IntentIntegrator integrator = new IntentIntegrator(NURUploadBarcodeNew.this);
                integrator.setDesiredBarcodeFormats(IntentIntegrator.ALL_CODE_TYPES);
                integrator.setCaptureActivity(AnyOrientationCaptureActivity.class);
                integrator.setCaptureActivity(TorchOnCaptureActivity.class);
                integrator.setOrientationLocked(false);
        ...
        if (a.hasExtra("barang")) {
           ...
           //  textnoreff.setText(barang.getNoref());
            ...
            textTampung.setText(barang.getKondisi());
...
//        Toast.makeText(this,"Load Barcode : "+notransaksi,Toast.LENGTH_LONG).show();
        String url = AppConfig.IP_SERVER+"gcnew/checkdatabarcodeimport.php";
    ...
    private void processResponsePOS3(String response){
        ...
        try {
            ...
            if (errormsg.equals("failed2"))
            {
                ...
                Intent a=new Intent(getBaseContext(),warningimport.class);
                startActivity(a);
            ...
            if (errormsg.equals("failed1"))
            {

                Intent a=new Intent(getBaseContext(),warningimportimportfilter.class);
                startActivity(a);
                // Toast.makeText(this,"CARI CARI",Toast.LENGTH_LONG).show();
...
//pDialog.hide();
    ...
    public void saveDataBarcode() {
        ...
        //showDialog();
        String urlx = AppConfig.IP_SERVER+"gcnew/savedatagc.php";
    ...
    private void DialogPerson() {
        ...
        protected void onActivityResult ( int requestCode, int resultCode, Intent data){
         ...
         //   loaddatavolley();
            ...
            qty.setText(data.getStringExtra("qty"));
//onBackPressed();
            //    Toast.makeText(getBaseContext(),"qty:"+qty.getText().toString()+"code:"+itemcode.getText().toString()+itemdesc.getText().toString(),Toast.LENGTH_SHORT).show();
            }
...
//pDialog.hide();
    ...
    private void processResponse4(String response){
        ...
        try {
            ...
            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(NURUploadBarcodeNew.this, simple_spinner_item, names);
...
*/
    ...
    private void DialogErrorNetwork() {
        dialog = new AlertDialog.Builder(NURUploadBarcodeNew.this);
        inflater = getLayoutInflater();
