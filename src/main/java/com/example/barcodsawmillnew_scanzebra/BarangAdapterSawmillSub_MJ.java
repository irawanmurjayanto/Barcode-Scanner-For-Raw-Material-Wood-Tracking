...
public class BarangAdapterSawmillSub_MJ extends RecyclerView.Adapter<BarangAdapterSawmillSub_MJ.BarangViewHolder> {

    AlertDialog.Builder dialog;
    LayoutInflater inflater;
    View dialogView;
    List<BarangSawmillLOG_MJ> barangs;
    Context ok;
    ADB_Master adb_master;
    public static int idno;
   View v;

    public BarangAdapterSawmillSub_MJ(List<BarangSawmillLOG_MJ> barangs) {
    ...
    public BarangViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_barangbarcode_mj, viewGroup,false);
    ...
    public BarangSawmillLOG_MJ getItem(int position) {
