...
public class BarangAdapterNOREFLokalLOG extends RecyclerView.Adapter<BarangAdapterNOREFLokalLOG.BarangViewHolder> {

    List<BarangSawmillLOGMain> barangs;
    public BarangAdapterNOREFLokalLOG(List<BarangSawmillLOGMain> barangs) {
    ...
    public BarangViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_barangbarcode_loglmain, viewGroup,false);
...
*/
    ...
    public BarangSawmillLOGMain getItem(int position) {
