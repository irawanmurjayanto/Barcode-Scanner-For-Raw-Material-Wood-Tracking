...
public class SawmillSub_Wrh extends AppCompatActivity  {
    ...
    private Context context = SawmillSub_Wrh.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textJudul.setText("Lokasi Warehouse");
            ...
            public void onClick(View view) {
                ...
                if (textTempSupplier.getText().toString().equals("Lokasi") || (textTempTipetrans.getText().toString().equals("Tipe"))) {
                   ...
                   // SawmillSub_Checkin.typebarcode="mastercheckin";
                    SawmillSub_LOG.typebarcode="masterwrh";
                    //ambilremarks = editremarks.getText().toString();
                    //Toast.makeText(getBaseContext(), "Load barcode", Toast.LENGTH_LONG).show();
                    IntentIntegrator integrator = new IntentIntegrator(SawmillSub_Wrh.this);
                    integrator.setDesiredBarcodeFormats(IntentIntegrator.ALL_CODE_TYPES);
                    integrator.setCaptureActivity(AnyOrientationCaptureActivity.class);
...
getLocation2();
  ...
  //  params
    ...
    private void setData(String noref) {
        ...
        SQLiteDatabase db = adb_master.getReadableDatabase();
        String sql = "select supplier,typetran from "+ADB_Master.MyColumns_newbarcode_wrh.NamaTabel+" where noref= '" + noref + "'";
        Cursor c = db.rawQuery(sql, null);
        int jum = c.getCount();
        hitbarc = jum;
...
*/
    ...
    private void insertdata() {
        ...
        String selectQuery2 = "SELECT  *  FROM " + ADB_Master.MyColumns_newbarcode_wrh.NamaTabel + " WHERE "
                + ADB_Master.MyColumns_newbarcode_wrh.noref + " = '" + textnoreff.getText().toString() + "' and " + ADB_Master.MyColumns_newbarcode_wrh.barcode + " = '" + item1 + "'";
        ...
        //    final String namacari = cari1.getText().toString();
            ...
            values2.put(ADB_Master.MyColumns_newbarcode_wrh.barcode,item1 );
            values2.put(ADB_Master.MyColumns_newbarcode_wrh.noref,textnoreff.getText().toString() );
            values2.put(ADB_Master.MyColumns_newbarcode_wrh.typetran,textTempTipetrans.getText().toString() );
            values2.put(ADB_Master.MyColumns_newbarcode_wrh.supplier,textTempSupplier.getText().toString() );
            values2.put(ADB_Master.MyColumns_newbarcode_wrh.tagtran,2 );//2 masuk 1 update
            create.insert(ADB_Master.MyColumns_newbarcode_wrh.NamaTabel, null, values2);
    ...
    //    String namaoven = textTampung3.getText().toString();
        ...
        SQLiteDatabase db = adb_master.getReadableDatabase();
        String sql = "select * from "+ADB_Master.MyColumns_newbarcode_wrh.NamaTabel+" where noref= '" + noref + "'";
        Cursor c = db.rawQuery(sql, null);
        int jum = c.getCount();
        hitbarc = jum;
        jumjumbar = String.valueOf(hitbarc);
        ...
        //  barangListPOS = adb_user.getSemuaUser();
         barangList = adb_master.getSemuaWrhsub(noref);
...
*/
    ...
    private void DialogErrorNetwork() {
        dialog = new AlertDialog.Builder(SawmillSub_Wrh.this);
        inflater = getLayoutInflater();
...
*/
    ...
    */
    ...
    private void insertto_test(final String norefx) {
        ...
        SQLiteDatabase db = adb_master.getWritableDatabase();
        String sql1 = "select barcode,tgl_rec,noref,lokasi from "+ADB_Master.MyColumns_newbarcode_wrh.NamaTabel +" where noref='" + textnoreff.getText().toString()+ "' ";
        Cursor cursor = db.rawQuery(sql1, null);
...
//        cursor2.moveToFirst();
//
//        String sql13 = "select max(tgl_rec) from "+ADB_Master.MyColumns_newbarcode_wrh.NamaTabel +" where noref='" + textnoreff.getText().toString()+ "' ";
...
//        cursor3.moveToFirst();
        ...
        Toast.makeText(getBaseContext(),"Last Barcode Size  "+databarcode.size(),Toast.LENGTH_LONG).show();
...
*/
    ...
    */
    ...
    /*    final String macadd1 = textgetmax.getText().toString();
        ...
        String url = AppConfig.IP_SERVER+"sawmill/lokal_insertdatasawmill_wrh_ori.php";
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Log.e("BarangActivityrsssss", response);
                ...
                try {
                    ...
                    if (errormsg.equals("fail"))
                    {
                        ...
                        Intent a = new Intent(getBaseContext(), warningumum.class);
                        a.putExtra("warning", "Upload Completed Warehouse Data");
                        startActivity(a);
                        hideDialog();
                    ...
                    Log.d("BarangActivityxxxxxx", "errorJSON");
...
//
//            Intent a = new Intent(getBaseContext(), warningumum.class);
//            a.putExtra("warning", "Upload Data Warehouse Completed ");
//            startActivity(a);
//        }
    }
...
//    }
    ...
    {
        SQLiteDatabase db=adb_master.getWritableDatabase();
        String upd1="update "+ADB_Master.MyColumns_newbarcode_wrh.NamaTabel+" set tagtran=1 where noref='"+norefx+"'";
        db.execSQL(upd1);
    }


    private void updateTextView(final String s) {
        SawmillSub_Wrh.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                EditText tv= (EditText) findViewById(R.id.editremarks);
                tv.setText("Text = "+s);
...
private void deldatatrans()
{
    ...
    {
        SQLiteDatabase db=adb_master.getWritableDatabase();
        String del1="delete from "+ADB_Master.MyColumns_newbarcode_wrh.NamaTabel+" where idno="+idno;
        db.execSQL(del1);

        String upd1="update "+ADB_Master.MyColumns_newbarcode_wrh.NamaTabel+" set tagtran='2' where noref='"+textnoreff.getText().toString()+"'";
        db.execSQL(upd1);
