...
public class WrhParis2Sambung extends AppCompatActivity {
    ...
    private Context context = WrhParis2Sambung.this;
...
private String wrhtype_get;
   ...
   public static String item_code,item_desc,qtygc;
        ...
        butprocwrh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                  ...
                  //  Intent a = new Intent(getBaseContext(), NURUploadBarcodeBatch.class);
                    Intent a = new Intent(getBaseContext(), WrhParisSub.class);
...
//        Toast.makeText(this,"Load Barcode : "+notransaksi,Toast.LENGTH_LONG).show();
        ...
        showDialog();
          ...
          url2 = AppConfig.IP_SERVER + "gcnew/android_listbarcode2putrasambung.php";
...
hideDialog();
    ...
    private void DialogErrorNetwork() {
        dialog = new AlertDialog.Builder(WrhParis2Sambung.this);
