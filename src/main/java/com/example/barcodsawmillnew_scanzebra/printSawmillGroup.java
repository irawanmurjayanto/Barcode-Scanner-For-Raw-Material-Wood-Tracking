...
public class printSawmillGroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pDialog = new ProgressDialog(printSawmillGroup.this);
...
*/
     ...
     //   if (Acc_Report.groupho.equals("1")) {
            ...
            web_view.loadUrl(AppConfig.IP_SERVER+"sawmill/lokal_sawmillreport.php?sw_group="+Report.sw_group+"&tgl_doc1="+Report.tgl1+"&tgl_doc2="+Report.tgl2);
