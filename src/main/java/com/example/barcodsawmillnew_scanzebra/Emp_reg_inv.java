...
public class Emp_reg_inv extends Activity {
    ...
    private Context context = Emp_reg_inv.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emp__reg_inv);
        ...
        mRecyclerViewdlg.addOnItemTouchListener(new RecyclerItemListener(context, new RecyclerItemListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                      ...
                      //  balik.putExtra("nama",barang.getNama());
                        balik.putExtra("noinv",barang.getItem_desc());
...
finish();
    ...
    public void loaddatanik(){
      ...
      // Toast.makeText(this,"Load Data "+getidovn,Toast.LENGTH_LONG).show();
        String url = AppConfig.IP_SERVER+"gcnew/list_invoice.php";
        ...
        try {
            ...
            for(int i = 0; i < jsonArray.length(); i++){
               ...
               //  objectbarang.setIDNO(obj.getInt("idno"));
                objectbarang.setItem_code("x1");
                objectbarang.setItem_desc(obj.getString("gr_no"));
                //objectbarang.setQty();
