...
public class SawmillSub_SWOut extends AppCompatActivity  {
    ...
    private Context context = SawmillSub_SWOut.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sawmill_swout);
       ...
       // simpleprogress.setProgress(0);
        ...
        butmanualbarc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (textTempSupplier.getText().toString().equals("Group") || (textTempTipetrans.getText().toString().equals("Tipe"))|| (textTemptujuan1.getText().toString().equals("Lokasi"))) {
            ...
            public void onClick(View view) {
                ...
                if (textTempSupplier.getText().toString().equals("Group") || (textTempTipetrans.getText().toString().equals("Tipe"))|| (textTemptujuan1.getText().toString().equals("Lokasi"))) {
                   ...
                   // SawmillSub_Checkin.typebarcode="mastercheckin";
                    SawmillSub_LOG.typebarcode="masterswout";
                    //ambilremarks = editremarks.getText().toString();
                    //Toast.makeText(getBaseContext(), "Load barcode", Toast.LENGTH_LONG).show();
                    IntentIntegrator integrator = new IntentIntegrator(SawmillSub_SWOut.this);
                    integrator.setDesiredBarcodeFormats(IntentIntegrator.ALL_CODE_TYPES);
                    integrator.setCaptureActivity(AnyOrientationCaptureActivity.class);
...
spnTipetrans.setEnabled(false);
  ...
  //  params
    ...
    private void setData(String noref) {
        ...
        SQLiteDatabase db = adb_master.getReadableDatabase();
        String sql = "select supplier,typetran,tujuan from "+ADB_Master.MyColumns_newbarcode_swout.NamaTabel+" where noref= '" + noref + "'";
        Cursor c = db.rawQuery(sql, null);
        int jum = c.getCount();
        hitbarc = jum;
...
*/
    ...
    private void insertdata() {
        ...
        String selectQuery2 = "SELECT  *  FROM " + ADB_Master.MyColumns_newbarcode_swout.NamaTabel + " WHERE "
                + ADB_Master.MyColumns_newbarcode_swout.noref + " = '" + textnoreff.getText().toString() + "' and " + ADB_Master.MyColumns_newbarcode_swout.barcode + " = '" + item1 + "'";
        ...
        //    final String namacari = cari1.getText().toString();
            ...
            values2.put(ADB_Master.MyColumns_newbarcode_swout.barcode,item1 );
            values2.put(ADB_Master.MyColumns_newbarcode_swout.noref,textnoreff.getText().toString() );
            values2.put(ADB_Master.MyColumns_newbarcode_swout.typetran,textTempTipetrans.getText().toString() );
            values2.put(ADB_Master.MyColumns_newbarcode_swout.supplier,textTempSupplier.getText().toString() );
            values2.put(ADB_Master.MyColumns_newbarcode_swout.tujuan,textTemptujuan1.getText().toString() );
            values2.put(ADB_Master.MyColumns_newbarcode_swout.tagtran,2 );//2 masuk 1 update
            create.insert(ADB_Master.MyColumns_newbarcode_swout.NamaTabel, null, values2);
    ...
    //    String namaoven = textTampung3.getText().toString();
        ...
        SQLiteDatabase db = adb_master.getReadableDatabase();
        String sql = "select * from "+ADB_Master.MyColumns_newbarcode_swout.NamaTabel+" where noref= '" + noref + "'";
        Cursor c = db.rawQuery(sql, null);
        int jum = c.getCount();
        hitbarc = jum;
        jumjumbar = String.valueOf(hitbarc);
        ...
        //  barangListPOS = adb_user.getSemuaUser();
         barangList = adb_master.getSemuaSwOutsub(noref);
...
//    }
    ...
    private void DialogErrorNetwork() {
        dialog = new AlertDialog.Builder(SawmillSub_SWOut.this);
        inflater = getLayoutInflater();
...
*/
    ...
    */
    ...
    private void updateTextView(final String s) {
        SawmillSub_SWOut.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                EditText tv= (EditText) findViewById(R.id.editremarks);
                tv.setText("Text = "+s);
...
private void deldatatrans()
{
    ...
    {
        SQLiteDatabase db=adb_master.getWritableDatabase();
        String del1="delete from "+ADB_Master.MyColumns_newbarcode_swout.NamaTabel +" where idno="+idno;
        db.execSQL(del1);

        String upd1="update "+ADB_Master.MyColumns_newbarcode_swout.NamaTabel+" set tagtran='2'  where noref='"+textnoreff.getText().toString()+"'";
        db.execSQL(upd1);
    }
    ...
    private void insertto_test(final String norefx) {
        ...
        SQLiteDatabase db = adb_master.getWritableDatabase();
        String sql1 = "select barcode,tgl_rec,noref,lokasi from "+ADB_Master.MyColumns_newbarcode_swout.NamaTabel +" where noref='" + textnoreff.getText().toString()+ "' ";
        Cursor cursor = db.rawQuery(sql1, null);
...
/*
        ...
        String sql13 = "select max(tgl_rec) from "+ADB_Master.MyColumns_newbarcode_swout.NamaTabel +" where noref='" + textnoreff.getText().toString()+ "' ";
        ...
        */
        ...
        Toast.makeText(getBaseContext(),"Last Barcode:  "+" size :"+String.valueOf(databarcode.size()),Toast.LENGTH_LONG).show();
      ...
      //  cursor.moveToFirst();
         //sqlserverinsert(cursor2.getString(0), cursor3.getString(0),textnoreff.getText().toString(),textTempSupplier.getText().toString() );
...
*/
    ...
    */
    ...
    /*    final String macadd1 = textgetmax.getText().toString();
        ...
        String url = AppConfig.IP_SERVER+"sawmill/lokal_insertdatasawmill_swout_ori.php";
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (errormsg.equals("fail"))
                    {
                        ...
                        Intent a = new Intent(getBaseContext(), warningumum.class);
                        a.putExtra("warning", "Upload Completed Sawmill Out");
                        startActivity(a);
                        hideDialog();
...
//
//            Intent a = new Intent(getBaseContext(), warningumum.class);
//            a.putExtra("warning", "Upload Sawmill Out Completed");
//            startActivity(a);
//        }
    }
    ...
    {
        SQLiteDatabase db=adb_master.getWritableDatabase();
        String upd1="update "+ADB_Master.MyColumns_newbarcode_swout.NamaTabel+" set tagtran=1 where noref='"+norefx+"'";
        db.execSQL(upd1);
    }
