...
public class BarangAdapterCabangSales extends RecyclerView.Adapter<BarangAdapterCabangSales.BarangViewHolder> {



    List<BarangCabang> barangs;
    public BarangAdapterCabangSales(List<BarangCabang> barangs) {
    ...
    public BarangViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_barang_adapter_cabangsales, viewGroup,false);
    ...
    /*    try {
     ...
     //   String dateTime = df.format(String.valueOf(barangs.get(i).getTgl_rec()));
       ...
       // barangViewHolder.barangIDNO.setText(String.valueOf(barangs.get(i).getIdno()));
        ...
        barangViewHolder.barangItem_desc.setText(barangs.get(i).getItem_desc());
     ...
     //   Switch barangSwitch;
        ...
        BarangViewHolder(View itemView) {
          ...
          //  barangIDNO = (TextView) itemView.findViewById(R.id.textIDNO);
            ...
            barangItem_desc = (TextView) itemView.findViewById(R.id.textitemdesc);
