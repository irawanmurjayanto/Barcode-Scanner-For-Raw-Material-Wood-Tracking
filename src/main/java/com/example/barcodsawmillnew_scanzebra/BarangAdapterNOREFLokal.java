...
public class BarangAdapterNOREFLokal extends RecyclerView.Adapter<BarangAdapterNOREFLokal.BarangViewHolder> {
    ...
    List<BarangSawmillLOG> barangs;
    public BarangAdapterNOREFLokal(List<BarangSawmillLOG> barangs) {
    ...
    public BarangViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_barangbarcode_logl, viewGroup,false);
...
*/
    ...
    public BarangSawmillLOG getItem(int position) {
