...
public class BarangAdapterSawmillExt extends RecyclerView.Adapter<BarangAdapterSawmillExt.BarangViewHolder> {

    List<BarangSawmillExt> barangs;
    public BarangAdapterSawmillExt(List<BarangSawmillExt> barangs) {
    ...
    //    barangViewHolder.barangJumlah.setText(String.valueOf(barangs.get(i).getJumbarc()+" / "+));
        ...
        barangViewHolder.barangSawmill.setText("SW : "+String.valueOf(barangs.get(i).getSawmill()+"  / "+barangs.get(i).getId()+" / Tgl. Beli: "+barangs.get(i).getTgl_beli()));
    ...
    public BarangSawmillExt getItem(int position) {
