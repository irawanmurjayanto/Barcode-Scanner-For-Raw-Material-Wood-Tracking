...
public class BarangAdapterSawmillAllLOG extends RecyclerView.Adapter<BarangAdapterSawmillAllLOG.BarangViewHolder> {

    AlertDialog.Builder dialog;
    LayoutInflater inflater;
    View dialogView;
    List<BarangSawmillAllLOG> barangs;
    Context ok;
    ADB_Master adb_master;
    public static int idno;
   View v;

    public BarangAdapterSawmillAllLOG(List<BarangSawmillAllLOG> barangs) {
    ...
    public BarangViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_barangbarcodealllog, viewGroup,false);
...
//                Toast.makeText(ok, "clicked on " +idno, Toast.LENGTH_SHORT).show();
//            }
//        });
//
    ...
    public BarangSawmillAllLOG getItem(int position) {
