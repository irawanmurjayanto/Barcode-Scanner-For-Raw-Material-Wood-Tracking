...
public class BarangAdapterCabangPutra extends RecyclerView.Adapter<BarangAdapterCabangPutra.BarangViewHolder> {



    List<BarangCabang> barangs;
    public BarangAdapterCabangPutra(List<BarangCabang> barangs) {
    ...
    public BarangViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_barang_adapter_cabang2, viewGroup,false);
