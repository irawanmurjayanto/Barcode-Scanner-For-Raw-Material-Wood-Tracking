...
public class NURUploadBarcodeNew2 extends AppCompatActivity {
    ...
    private Context context = NURUploadBarcodeNew2.this;
    ...
    TextView t0, t1, textTampung, textTampung2, textTampung3, textnoreff, statustran,itemcode,itemdesc;
    Button butpos1, butovenname, butmanualbarc, butmanualbarcdel, butdelbarctran, butdelnoref,butitem;
    private SimpleDateFormat dateFormatter;
    Spinner spnOven;
    private String a1;
    private static int hitbarc;
    private static final String Json_URL_POS = AppConfig.IP_SERVER + "gcnew/savebarcode.php";
    Button butsavegc,butclosegc,butdelgc,butmnl;

    EditText qty,remarks;
    TextView item_code,item_desc,textIDNO,statusbarang;
    public  static  String savetag;
    private static String urldel;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_inventory__barangnew2);
        ...
        statusbarang=(TextView)findViewById(R.id.statusbarang);
      //  textnoreff = (TextView) findViewById(R.id.textnoref);
        statustran = (TextView) findViewById(R.id.statustrans);

        itemcode = (TextView) findViewById(R.id.codebarang);
        itemdesc = (TextView) findViewById(R.id.namabarang);
        textIDNO = (TextView) findViewById(R.id.textIDNO);

        //    toolbar.setTitle("Barcode Upload");
        //setSupportActionBar(toolbar);
       cari1 = (EditText) findViewById(R.id.cariText);
        butitem=findViewById(R.id.butitem);

        butsavegc=findViewById(R.id.butsavegc);
        butdelgc=findViewById(R.id.butdelgc);
      //  butclosegc=findViewById(R.id.butclosegc);
        butmnl=findViewById(R.id.butmnl);


        item_code=findViewById(R.id.codebarang);
        item_desc=findViewById(R.id.namabarang);
        qty=findViewById(R.id.editjumlah);
        remarks=findViewById(R.id.editremarks);
     ...
     //   butdelnoref = (Button) findViewById(R.id.butdelnoref);
        ...
        butmnl.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        butsavegc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               // Intent a=new Intent(getBaseContext(),Emp_RegItemdesc.class);
                //  a.putExtra("wrhtype",wrhtype_get);
    ...
    public void onClick(View v) {
        ...
        if (cari1.getText().toString().isEmpty()) {
            Toast.makeText(getBaseContext(), "Anda Harus Isi barcode" + savetag, Toast.LENGTH_SHORT).show();
            return;
    ...
    /*    cari1.setOnKeyListener(new View.OnKeyListener() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                butsavegc.setEnabled(true);
                //Toast.makeText(getBaseContext(), "Load barcode", Toast.LENGTH_LONG).show();
                IntentIntegrator integrator = new IntentIntegrator(NURUploadBarcodeNew2.this);
                integrator.setDesiredBarcodeFormats(IntentIntegrator.ALL_CODE_TYPES);
                integrator.setCaptureActivity(AnyOrientationCaptureActivity.class);
                integrator.setCaptureActivity(TorchOnCaptureActivity.class);
                integrator.setOrientationLocked(false);
        ...
        if (a.hasExtra("barang")) {
           ...
           //  textnoreff.setText(barang.getNoref());
            ...
            cari1.setText(barang.getBarcode());
            textIDNO.setText(barang.getIdno());
            item_code.setText(barang.getItem_code());
            item_desc.setText(barang.getItem_desc());
            qty.setText(String.valueOf(barang.getQtygc()));
            remarks.setText(barang.getRemarks());
            textTampung.setText(barang.getTujuan());
            toolbar.setTitle("Edit Transaction "+barang.getTypetran());
            qty.setEnabled(false);
            statusbarang.setText(barang.getKondisi());

cari1.setEnabled(false);
spnOven.setEnabled(true);
            statustran.setEnabled(false);
            //Toast.makeText(NURUploadBarcodeNew.this, "Qty"+String.valueOf(barang.getQtygc()), Toast.LENGTH_SHORT).show();
            savetag="0";
          ...
          //  textnoreff.setText(a1 + dateFormatter.format(newDate.getTime()));
           ...
           statustran.setText(a1);
            ...
            cari1.setEnabled(true);
            spnOven.setEnabled(true);
            statustran.setEnabled(false);
           // qty.setEnabled(false);

            toolbar.setTitle("New Transaction "+a1);

        }



        butdelgc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Intent a=new Intent(getBaseContext(),Emp_RegItemdesc.class);
                //  a.putExtra("wrhtype",wrhtype_get);
                //startActivityForResult(a,333);
                DialogDelNoref(textIDNO.getText().toString());
                // finish();
    ...
    public void saveDataBarcode() {
        ...
        if (cari1.getText().toString().length()==0) {
           // Toast.makeText(getBaseContext(), "Anda Harus Isi barcode" + savetag, Toast.LENGTH_SHORT).show();
            Intent a=new Intent(getBaseContext(),warningumum.class);
            a.putExtra("warning","Anda Harus isi Barcode dulu");
            startActivity(a);
            return;

        }

      //  Toast.makeText(getBaseContext(), "Anda Harus Isi Qty" + qty.getText().toString().length(), Toast.LENGTH_SHORT).show();

        if (qty.getText().toString().length()==0) {
          //  Toast.makeText(getBaseContext(), "Anda Harus Isi Qty" + savetag, Toast.LENGTH_SHORT).show();
            Intent a=new Intent(getBaseContext(),warningumum.class);
            a.putExtra("warning","Anda Harus isi Qty dulu");
            startActivity(a);
            return;
      ...
      //Toast.makeText(getBaseContext(),"responsexxxx: "+savetag, Toast.LENGTH_SHORT).show();
        ...
        //showDialog();
        String urlx = AppConfig.IP_SERVER+"gcnew/savedatagc2ex.php";
            ...
            protected Map<String, String> getParams() {
             ...
             //   params.put("item_code", item_code.getText().toString());
              ...
              //  params.put("remarks", remarks.getText().toString());
                ...
                //params.put("idno", textIDNO.getText().toString());
    ...
    private void DialogPerson() {
        ...
        protected void onActivityResult ( int requestCode, int resultCode, Intent data){
         ...
         /*   if (resultCode == RESULT_OK && requestCode == 333) {
            ...
            itemcode.setText(data.getStringExtra("item_code"));
             itemdesc.setText(data.getStringExtra("item_desc"));
...
//        Toast.makeText(this,"Load Barcode : "+notransaksi,Toast.LENGTH_LONG).show();
        String url = AppConfig.IP_SERVER+"gcnew/checkdatabarcode.php";
...
//                pDialog.hide();
...

            {
                ...
                params.put("cari",cari1.getText().toString());
    ...
    private void processResponsePOS3(String response){
        ...
        try {
            ...
            }else
            {
                ...
                for(int i = 0; i < jsonArray.length(); i++){
                   ...
                   item_code.setText(obj.getString("item_code"));
                   item_desc.setText(obj.getString("item_desc"));
                    qty.setText(obj.getString("qty"));
                    statusbarang.setText(obj.getString("kondisi"));

                //    Toast.makeText(this,"CARI CARI"+obj.getString("item_code"),Toast.LENGTH_LONG).show();
...
//pDialog.hide();
    ...
    public void loaddatavolley(){
       ...
       // final String kodecabang1=intent.getStringExtra("kodecabang");
//        Toast.makeText(this,"Load Barcode : "+notransaksi,Toast.LENGTH_LONG).show();
        String url = AppConfig.IP_SERVER+"gcnew/android_listbarcode2sub.php";
        //String url ="http://golden-care.co.id/android/listdata.php";
//        pDialog = new ProgressDialog(Transaksi_POS.this);
        //      pDialog.setMessage("Retieve Data Barang...");
        // Toast.makeText(this,"Load Barcode : "+notransaksi,Toast.LENGTH_LONG).show();
...
//pDialog.hide();
    ...
    private void processResponse4(String response){
        ...
        try {
            ...
            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(NURUploadBarcodeNew2.this, simple_spinner_item, names);
    ...
    /*    final String macadd1 = textgetmax.getText().toString();
        ...
        if (statustran.getText().toString().equals("import")) {

             urldel = AppConfig.IP_SERVER+"gcnew/delnoref.php";
        }else
        {
            urldel = AppConfig.IP_SERVER+"gcnew/delnoref2.php";
        }



        StringRequest postRequest = new StringRequest(Request.Method.POST, urldel, new Response.Listener<String>() {
...
*/
    ...
    /*    final String macadd1 = textgetmax.getText().toString();
        ...
        String url = "sawmill/barcsw_insertbarctran.php";
...
*/
    ...
    private void DialogErrorNetwork() {
        dialog = new AlertDialog.Builder(NURUploadBarcodeNew2.this);
        inflater = getLayoutInflater();
