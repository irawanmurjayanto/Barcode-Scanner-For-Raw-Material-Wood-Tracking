...
public class WrhParis extends AppCompatActivity {

    public static final String TAG_JSON_ARRAY="result";
    private RecyclerView mRecyclerView;

    private RecyclerView mRecyclerViewpos;
    private BarangAdapterCabang rvAdapterpos;
    ...
    private Context context = WrhParis.this;
...
private String wrhtype_get;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wrh_paris);
    ...
    private void gambarDatakeRecyclerView(){
        ...
        rvAdapterpos = new BarangAdapterCabang(barangListPOS);
...
//        Toast.makeText(this,"Load Barcode : "+notransaksi,Toast.LENGTH_LONG).show();
        ...
        if (wrhtype_get.equals("import")) {
          ...
          url2 = AppConfig.IP_SERVER + "gcnew/android_listbarcode2.php";
        }else
        {
...
hideDialog();
    ...
    private void DialogErrorNetwork() {
        dialog = new AlertDialog.Builder(WrhParis.this);
