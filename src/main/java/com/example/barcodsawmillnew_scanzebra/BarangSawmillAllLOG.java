...
public class BarangSawmillAllLOG implements Serializable{
    ...
    public BarangSawmillAllLOG(int id, String noref, String barcode, String supplier, String tipetrans, String tglrec, int tagtran, int nourut) {
        this.id = id;
        this.noref = noref;
