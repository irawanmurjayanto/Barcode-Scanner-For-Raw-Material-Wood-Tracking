...
public class BarangSawmill implements Serializable{
    ...
    public BarangSawmill(int id, double volume, int idno_link1, String sawmill, String supplier_name, String tipe_kayu, int no_log, double panjang, double lebar, double tinggi, double diameter, String tgl_beli, int jumbar, int tagtran) {
        this.id = id;
        this.volume = volume;
